...
image:http://img.shields.io/badge/license-MIT-blue.svg?style=flat[MIT License, link=https://github.com/asciidoctor/atom-asciidoc-preview/blob/master/LICENSE.md]
